...
이 저장소는 **[MIT License](LICENSE)** 를 따릅니다. 요약하면 사용·복제·수정·배포·상업적 이용이 가능하며, **저작권·면책 고지를 포함**하면 됩니다. (법적 해석은 원문 LICENSE를 기준으로 하세요.)

조직·행사에서 **다른 라이선스**를 요구하면, 해당 규정에 맞춰 `LICENSE`와 이 문단을 바꾸면 됩니다.
